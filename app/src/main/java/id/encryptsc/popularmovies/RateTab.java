...
public class RateTab extends Fragment{
    ...
    public static class MoviesAdapter extends RecyclerView.Adapter<PopularTab.MovieViewHolder> {
        ...
        @Override
        public PopularTab.MovieViewHolder onCreateViewHolder(ViewGroup parent, final int viewType) {
            View view = mInflater.inflate(R.layout.rows, parent, false);
            final PopularTab.MovieViewHolder viewHolder = new PopularTab.MovieViewHolder(view);
        ...
        @Override
        public void onBindViewHolder(PopularTab.MovieViewHolder holder, int position) {
